    ...
    return (
            ...
            <div className="container">
                <div className="hero-content">
                    ...
                    <p className="hero-subtitle">
                        The University of Nottingham's Premier Formula Student AI Team.
                        We design, build, and race the next generation of autonomous vehicles.
                    </p>
        ...
        <section id="about" className="section">
            <div className="container">
                ...
                <p className="section-subtitle">We are a dedicated group of students from the University 
                    of Nottingham, united by a passion for motorsport, artificial intelligence, 
                    and cutting-edge engineering. Our mission is to push the boundaries of
                    autonomous vehicle technology and compete at the highest level of Formula Student AI.</p>
                
                <div className="team-grid">
                    <div className="team-card">
                        <img src="https://placehold.co/200x200/F5FBEF/0A192F?text=Team+Lead" 
                            alt="Team Lead" className="team-photo" />
                        <h3 className="team-name">Alex Johnson</h3>
                        <p className="team-role">Team Lead</p>
                    </div>
                    <div className="team-card">
                        <img src="https://placehold.co/200x200/F5FBEF/0A192F?text=Software" 
                            alt="Software Lead" className="team-photo" />
                        <h3 className="team-name">Ben Carter</h3>
                        <p className="team-role">Software Lead</p>
                    </div>
                    <div className="team-card">
                        <img src="https://placehold.co/200x200/F5FBEF/0A192F?text=Hardware" 
                            alt="Hardware Lead" className="team-photo" />
                        <h3 className="team-name">Chloe Davis</h3>
                        <p className="team-role">Hardware Lead</p>
                    </div>
                    <div className="team-card">
                        <img src="https://placehold.co/200x200/F5FBEF/0A192F?text=Business" 
                            alt="Business Lead" className="team-photo" />
        ...
        <section id="gallery" className="section alt">
            ...
            <p className="section-subtitle">From late-night builds in the workshop to the thrill
                of the racetrack, here's a glimpse into the world of NottsAir.</p>
        ...
        <section id="sponsors" className="section">
            <div className="container">
                ...
                <p className="section-subtitle">Our success is driven by the generous support of our partners.
                    Their contributions provide us with the resources needed to innovate and compete. 
                    We are incredibly grateful for their belief in our vision.</p>
